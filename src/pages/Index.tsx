...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-subtle">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div className="inline-block">
                <span className="px-4 py-2 bg-solar/10 text-solar font-medium text-sm rounded-full border border-solar/20">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-energy opacity-20 blur-3xl rounded-full" />
              <img 
                src={heroImage}
      ...
      <section className="py-12 bg-card/30 backdrop-blur-sm border-y border-border/50">
      ...
      {/* Charging Stations */}
      <section id="stations" className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <div>
